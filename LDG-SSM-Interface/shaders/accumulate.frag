...
{
    return 1.0 - pow(1.0 - alpha, sample_ratio);
}
...
void accumulation(float value, float sample_ratio, inout vec4 composed_color)
{
    ...
    composed_color.a += (1. - composed_color.a) * color.a;
}
...
void main(void)
{
    ...
    float sample_ratio = 1. / (num_samples * voxel_width);
